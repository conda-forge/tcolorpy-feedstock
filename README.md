...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tcolorpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10444&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tcolorpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tcolorpy` can be installed with:

```
conda install tcolorpy
```

It is possible to list all of the versions of `tcolorpy` available on your platform with:
